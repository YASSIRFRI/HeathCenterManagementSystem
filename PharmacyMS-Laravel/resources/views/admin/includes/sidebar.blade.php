		...
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						<li><a class="{{ route_is('sales.*') ? 'active' : '' }}" href="{{route('sales.index')}}">Consumed</a></li>
						@can('create-sale')
						<li><a class="{{ route_is('sales.create') ? 'active' : '' }}" href="{{route('sales.create')}}">Consume a product</a></li>
						@endcan
					</ul>
				</li>
				@endcan
