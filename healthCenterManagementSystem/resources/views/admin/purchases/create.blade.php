						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-check">
									<input class="form-check-input" type="checkbox" id="is_medical_equipment" name="is_medical_equipment">
									<label class="form-check-label" for="is_medical_equipment">Medical Equipment</label>
								</div>
							</div>
						</div>
					</div>
...
@push('page-js')
	...
	<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			const isMedicalEquipmentCheckbox = document.getElementById('is_medical_equipment');
			isMedicalEquipmentCheckbox.addEventListener('change', function () {
				expiryDateField.disabled = this.checked;
			});
		});
	</script>
@endpush
